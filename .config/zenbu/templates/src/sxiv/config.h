 ...
 */
static const char * const BAR_FONT ="kakwafont:size=8";
/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "{{ bgc }}";
static const char * const WIN_FS_COLOR = "{{ b_black }}";
static const char * const SEL_COLOR    = "{{ b_black }}";
static const char * const BAR_BG_COLOR = "{{ n_black }}";
static const char * const BAR_FG_COLOR = "{{ fgc }}";
