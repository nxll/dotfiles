...
if &background == "light"
    ...
    hi Statement gui=NONE guifg=#4a4a4a guibg=NONE ctermfg=154
...
elseif &background == "dark"
    ...
    hi ColorColumn gui=NONE guifg=NONE guibg=#121212 ctermfg=015
    hi Comment gui=NONE guifg=#707070 guibg=NONE ctermfg=253 ctermbg=234
    hi Conceal gui=NONE guifg=#808080 guibg=NONE ctermfg=015
    hi Conditional gui=NONE guifg=#8f8f8f guibg=NONE ctermfg=015
    hi Constant gui=NONE guifg=#808080 guibg=NONE ctermfg=015
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    ...
    hi DiffAdd gui=NONE guifg=NONE guibg=#141414 ctermfg=015
    hi DiffChange gui=NONE guifg=NONE guibg=#1a1a1a ctermfg=015
    hi DiffDelete gui=NONE guifg=NONE guibg=#212121 ctermfg=015
    hi DiffText gui=NONE guifg=NONE guibg=#333333 ctermfg=015
    hi Directory gui=NONE guifg=#acdb0f guibg=#141414 ctermfg=015
    hi Error gui=NONE guifg=NONE guibg=#171717 ctermfg=255
    hi ErrorMsg gui=NONE guifg=#2b2b2b guibg=#121212
    hi FoldColumn gui=NONE guifg=#616161 guibg=NONE ctermfg=154
    hi Folded gui=NONE guifg=#707070 guibg=NONE ctermfg=015
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    hi IncSearch gui=NONE guifg=NONE guibg=#333333 ctermfg=015
    hi LineNr gui=NONE guifg=#acdb0f guibg=#121212 ctermfg=236 ctermbg=234
    hi MatchParen gui=NONE guifg=NONE guibg=#333333 ctermfg=015
    hi ModeMsg gui=NONE guifg=#303030 guibg=#121212 ctermfg=236 ctermbg=234
    hi MoreMsg gui=NONE guifg=#303030 guibg=#121212 ctermfg=154
    hi NonText gui=NONE guifg=#616161 guibg=#141414 ctermfg=233
    hi Normal gui=NONE guifg=#ffffff guibg=#141414 ctermfg=015
    ...
    hi Special gui=NONE guifg=#808080 guibg=NONE ctermfg=242
    ...
    hi String gui=NONE guifg=#808080 guibg=NONE ctermfg=015
    ...
    hi Underlined gui=NONE guifg=NONE guibg=NONE ctermfg=015
    hi VertSplit gui=NONE guifg=#333333 guibg=NONE ctermfg=234 ctermbg=NONE
    hi Visual gui=NONE guifg=NONE guibg=#121212 ctermfg=015
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE ctermfg=015
    ...
    hi PreProc gui=NONE guifg=NONE guibg=NONE ctermfg=015
endif
