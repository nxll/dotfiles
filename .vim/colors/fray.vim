...
if &background == "light"
    ...
    hi StatusLine   gui=NONE ctermfg=0    ctermbg=238
    hi StatusLineNC gui=NONE ctermfg=0    ctermbg=236
    ...
    hi TabLineFill  gui=NONE ctermfg=0    ctermbg=7
    hi TabLineSel   gui=NONE ctermfg=7    ctermbg=234  cterm=NONE
    hi Title 	    gui=NONE ctermfg=236  ctermbg=0
    ...
    hi Visual 	    gui=NONE ctermfg=236  ctermbg=0
